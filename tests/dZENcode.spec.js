...
//await expect(page.locator('.cart-item', { hasText: 'Mushroom' }).locator('.quantity').nth(1)).toHaveText('3 No.'); //Эта проверки "отключена" для прохождения сценария указаного в ТЗ. Т.К. Она обнаруживает дефект и прохождение по сценарию не возможно
